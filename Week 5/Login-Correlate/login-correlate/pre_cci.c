# 1 "c:\\users\\ericsuminski\\desktop\\loadrunnerish\\test\\login-correlate\\login-correlate\\\\combined_login-correlate.c"
...
# 1 "c:\\users\\ericsuminski\\desktop\\loadrunnerish\\test\\login-correlate\\login-correlate\\\\combined_login-correlate.c" 2
...
# 2 "c:\\users\\ericsuminski\\desktop\\loadrunnerish\\test\\login-correlate\\login-correlate\\\\combined_login-correlate.c" 2
...
# 3 "c:\\users\\ericsuminski\\desktop\\loadrunnerish\\test\\login-correlate\\login-correlate\\\\combined_login-correlate.c" 2
...
# 4 "c:\\users\\ericsuminski\\desktop\\loadrunnerish\\test\\login-correlate\\login-correlate\\\\combined_login-correlate.c" 2
...
Action()
{
	...
	web_url("localhost:8080", 
		...
		lr_end_transaction("open login", 2);
	...
	lr_end_transaction("open registration", 2);
	...
	web_custom_request("register", 
		...
		lr_end_transaction("register account", 2);
	...
	lr_end_transaction("open dashboard", 2);
	...
	web_url("todo", 
		...
		lr_end_transaction("get todos", 2);
...
# 5 "c:\\users\\ericsuminski\\desktop\\loadrunnerish\\test\\login-correlate\\login-correlate\\\\combined_login-correlate.c" 2
...
# 6 "c:\\users\\ericsuminski\\desktop\\loadrunnerish\\test\\login-correlate\\login-correlate\\\\combined_login-correlate.c" 2
